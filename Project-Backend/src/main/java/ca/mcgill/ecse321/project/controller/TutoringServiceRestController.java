...
//	}
	...
	//Get course offering that the review belongs to.
	
	//Get all reviews for a course offering.
...
// ******************************************* Conversion to  DTO ********************************************* \\
	...
	public SessionDTO updateSession(@RequestParam(name = "sessionId") Integer sId, 
