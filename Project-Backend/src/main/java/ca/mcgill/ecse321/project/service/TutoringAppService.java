...
//		service.createRoom(3);
		...
		// create a tutor
		createUser("aName", "alexander.gruenwald19@gmail.com", 22, "5145555555");
		Tutor t = createTutor("agruenwald", "password", "alexander.gruenwald19@gmail.com", 12, 3, Education.highschool);
		...
		createAvailability(AVAILABILITY_DATE, AVAILABILITY_TIME, "agruenwald");
		createAvailability(AVAILABILITY_DATE2, AVAILABILITY_TIME2, "agruenwald");
...
//		// create a session
		createSession(c1.getCourseOfferingID(), AVAILABILITY_DATE, AVAILABILITY_TIME, 12.0, "cmc", "agruenwald");
		
		// create some reviews
		createText("Best tutor ever", true, "agruenwald", c1.getCourseOfferingID());
		createRating(5, "agruenwald", c1.getCourseOfferingID());
		createText("Worst tutor ever", true, "agruenwald", c2.getCourseOfferingID());
		createRating(1, "agruenwald", c3.getCourseOfferingID());
