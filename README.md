...
<ol>
  <li>Machine learning face recognition for signing up. See below for ML setup. License.txt file above shows our references for the YOLO software used for facial recognition.
